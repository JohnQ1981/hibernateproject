...
public class Question11 {
	 ...
	 */
	@OneToMany(orphanRemoval = true,cascade = CascadeType.ALL) //(mappedBy = "question", orphanRemoval = true, cascade = CascadeType.ALL)
	@JoinColumn(name = "question_id")//,orphanRemoval = true,cascade = CascadeType.AL)
